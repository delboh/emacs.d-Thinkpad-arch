...
(setq-default
 ...
 large-file-warning-threshold 25000000)           ; nil to turn off completely
...
(use-package citar
  ...
  (citar-bibliography '("~/Dropbox/Zotero_Libraries/MyLibrary.json")) ;;List of bibliography files
...
;; Open embark menu with org-open-at-point
...
(use-package org
  ...
  (setq org-cite-global-bibliography '("~/Dropbox/Zotero_Libraries/MyLibrary.json")
        ...
        ;; '((md . (csl "~/Dropbox/Zotero_Libraries/styles/harvard-anglia-ruskin-university.csl"))
        ;;   (latex . (csl "~/Dropbox/Zotero_Libraries/styles/harvard-anglia-ruskin-university.csl"))
        ;;   (odt . (csl "~/Dropbox/Zotero_Libraries/styles/harvard-anglia-ruskin-university.csl"))
        ;;   (t . (csl "~/Dropbox/Zotero_Libraries/styles/harvard-anglia-ruskin-university.csl")))) ; fallback
