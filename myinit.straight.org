...
#+begin_src emacs-lisp
  ...
  (use-package abbrev
    ...
    (global-abbrev-mode 1)  ;; Enable everywhere
    :hook
  (text-mode . my/text-mode-abbrev-setup)) ;; Use function to set text mode files to use global

  (defun my/text-mode-abbrev-setup ()
  "Ensure text-mode and derived modes use the global abbrev table."
