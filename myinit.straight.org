...
#+begin_SRC emacs-lisp
     ...
     (use-package citar
       ...
       :bind (("C-c r" . citar-insert-reference) ; functions outside of org-mode
              :map org-mode-map
...
#+END_SRC
* consult / vertico / orderless / marginalia / tempel
#+BEGIN_SRC emacs-lisp
 ...
 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ;; TEMPEL simple, in-buffer template expansion
 (use-package tempel
   :ensure nil
   :bind (("M-+" . tempel-complete)) ;; Optional: manual trigger
   :init
   ;; Add to Org mode
   ;; (add-hook 'org-mode-hook #'tempel-setup-capf)
   ;; Add to other modes if needed
   ;; (add-hook 'text-mode-hook #'tempel-setup-capf)
 )
 (setq tempel-templates
       '((org-block
          "#+begin_${1:flushright|mesostic|}\n$0\n#+end_$1")))
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; line numbers mode
  (global-set-key (kbd "<S-f7>") #'display-line-numbers-mode)
  ...
  (put 'org-narrow-to-element 'disabled nil)
...
#+BEGIN_SRC emacs-lisp 
  (use-package org
    ...
    (setq-default ;; buffer local variables
     ...
     org-startup-indented nil                        ; interferes with flyspell
     )
    (setq org-directory "~/org"
  		...
  		org-adapt-indentation 'headline-data                                                     ; don't indent [t nil 'headline-data]
