#+STARTUP: content
* org-latex hanging colon bug fix (Emacs29)
#+BEGIN_SRC emacs-lisp
(defun my/org-remove-hanging-colon-from-ref (ref)
  "Remove the hanging colon tokens from the exported label REF."
  (replace-regexp-in-string "\\\\kern -\\\\h@ngcolonwd\\\\kern \\\\h@ngcolonwd" "" ref))

(advice-add 'org-export-get-reference :filter-return #'my/org-remove-hanging-colon-from-ref)
