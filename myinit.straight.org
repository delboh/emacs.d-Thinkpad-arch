...
# * default directory
# #+begin_SRC emacs-lisp
# (setq default-directory "c:\\Users\\delbo\\iCloudDrive\\27N4MQEA55~pro~writer\\")
# #+end_SRC
* better defaults
#+begin_SRC emacs-lisp
(setq-default
 ...
 ;; backup-directory-alist `(("." . "~/.saves"))     ; Keep backup files in specified location
...
(global-hl-line-mode nil)                         ; Hightlight current line
...
* org agenda speedup and optimization
#+BEGIN_SRC emacs-lisp

;; custom commands
;; (setq org-agenda-custom-commands
;;       '((" " "Reading" agenda "List of rendez-vous and tasks for today"
;;          ((org-agenda-files '("~/org/rdv.org" "~/org/bzg.org"))))))

;; Inhibit agenda files startup options
;; (setq org-agenda-inhibit-startup t) 

;; disable tag-inheritance in agenda files
;; (setq org-agenda-use-tag-inheritance nil)

;; Disable parsing for some drawer properties
;; (setq org-agenda-ignore-drawer-properties '(effort appt category))

;; Don't search archive files for ids
...
#+begin_SRC emacs-lisp
  ...
  (use-package citar
    ...
    ;; citar-notes-paths '("c:\\Users\\delbo\\iCloudDrive\\iCloud~com~logseq~logseq\\pages\\") ;; List of directories for reference nodes
...
#+begin_src emacs-lisp
  ...
  ;;   :ensure t
  ;;   :config
  ;;   (setq deft-directory "c:\\Users\\delbo\\iCloudDrive\\org-roam\\"
  ;;         deft-recursive t
...
#+begin_SRC emacs-lisp
  ...
  ;; (setq denote-directory "C:\\Users\\delbo\\iCloudDrive\\27N4MQEA55~pro~writer")
    ...
    (let (word)
      (setq word
            (if (use-region-p)
              ...
              (current-word)))
      (setq word (replace-regexp-in-string " " "_" word))
      (browse-url (concat "https://www.oed.com/search?searchType=dictionary&q="word"&_searchBtn=Search"))
...
#+begin_src emacs-lisp
  ...
  ;;         org-journal-dir "c:\\Users\\delbo\\iCloudDrive\\27N4MQEA55~pro~writer\\org\\"
...
(setq bibtex-completion-bibliography '("~/Dropbox/Zotero_Libraries/MyLibrary.bib")
      ;; bibtex-completion-library-path '("C:\\Users\\delbo\\iCloudDrive\\org-pdfs\\")
      bibtex-completion-notes-path "C:/Users/delbo/Dropbox/bibliography/notes/"
